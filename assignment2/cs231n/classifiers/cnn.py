...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        C, H, W = input_dim
        HH = filter_size
        self.params['W1'] = np.random.normal(loc=0, scale= weight_scale, size=(num_filters, C, HH, HH))
    ...
    def loss(self, X, y=None):
        ...
        dout, grads['W3'], grads['b3'] = affine_backward(dscores, cache_A)
        dhidden, grads['W2'], grads['b2'] = affine_relu_backward(dout, cache_AR)
        dx, grads['W1'], grads['b1'] = conv_relu_pool_backward(dhidden, cache_CRP)
